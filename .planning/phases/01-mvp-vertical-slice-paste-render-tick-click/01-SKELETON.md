...
Sarah can open `agenda-presenter.html` from disk, paste agenda Markdown, render title and agenda slides, click the sidebar, and run a truthful countdown timer with overrun state.
...
| Deployment | Local file open only | The product is distributed as `agenda-presenter.html` |

## Stack Touched in Phase 1

- [x] Local project scaffold: `agenda-presenter.html`
