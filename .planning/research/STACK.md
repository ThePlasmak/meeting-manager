...
2. Paste its contents inside `<script>...</script>` in your HTML file, OR keep it as a separate sibling file `marked.umd.min.js` next to `agenda-presenter.html` and reference it with `<script src="marked.umd.min.js"></script>`.
